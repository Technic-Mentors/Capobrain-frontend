...
export default function Homeworkmarli() {
  return (
    <div className='container'>
      <h1 style={{color:"#FAC400"}}>Homework Marking List</h1>
      ...
      <img src="/img/Summer-Vacation-Homework-Marking-List.png" className='img-fluid' alt="Summer-Vacation-Homework-Marking-List" />
    </div>
  )
}
